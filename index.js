...
const summaryString = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. 
Currently, ${unfunded.length} ${unfunded.length === 1 ? "game remains" : "games remain"} unfunded. 
...
// Sort the games from most to least pledged
...
// Create elements to display the game names and append them
